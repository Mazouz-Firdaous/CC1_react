...
/******fonction toggleTodo******************/
    ...
    <div className="m-auto px-4 col-12 col-sm-10 col-lg-6" >
        <form onSubmit={e => addTodo(e)} className="mb-3">
            <label htmlFor="todo" className="form-label mt-3"><h4>Ma liste </h4></label>
            <div className="d-flex">
            <input type="text" className="form-control mx-2 " id="todo" value={valtxt}    onChange={(e)=>modifytext(e)} placeholder='insérer un élément'/>
            <button className="mx-2 btn btn-primary d-block">Envoyer</button>
            </div>
        </form>
